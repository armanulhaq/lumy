            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="relative group">
                        <div className="relative bg-primary/5 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
